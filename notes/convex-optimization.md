...
$$\begin{aligned}
x_k &= \argmin{x}\ f(x) + \frac{\rho}{2}x^TA^TAx + \rho x^TA^T\block{B z_k - c - u_k}^2 \\
z_{k+1} &= \argmin{z}\ g(z) + \frac{\rho}{2}z^TB^TBz + \rho z^T\block{Ax_k - c - u_k}^2 \\
\end{aligned}
$$
...
$$\begin{aligned}
x_k &= \argmin{x}\ f(x) + \frac{\rho}{2}\norm{x}^2 - \rho x^T\block{u_k + z_k}^2 \\
z_{k+1} &= \argmin{z}\ g(z) + \frac{\rho}{2}\norm{z}^2 - \rho z^T\block{u_k - x_k}^2 \\
\end{aligned}
$$
